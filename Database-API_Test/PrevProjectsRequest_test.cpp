...
TEST(ExtractPrevProjectsRequestTests, MultipleProjects)
{
	...
	Version version4_1 = 5000000001001;
	ProjectID projectID4_2 = 3;
	Version version4_2 = 5000000002001;
	ProjectID projectID4_3 = 2;
	Version version4_3 = 5000000002001;
...
TEST(ExtractPrevProjectsRequestTests, TooFewArguments)
{
	...
	std::string output5 = handler.handleRequest("gppr", input5, nullptr);
