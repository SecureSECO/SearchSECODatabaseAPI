...
TEST(DatabaseIntegrationTest, CheckRequestSingleHash)
{
	...
	Utility::appendBy(
		expectedChars,
		{input1, "1", "5000000000000", "M1", "P1/M1.cpp", "1", "1", "68bd2db6-fe91-47d2-a134-cf82b104f547"},
...
TEST(DatabaseIntegrationTest, CheckRequestMultipleHashes)
{
	...
	Utility::appendBy(
		expectedChars,
		{"137fed017b6159acc0af30d2c6b403a5", "3", "5000000002000", "M3", "P3/M3.cpp", "1", "1", "b2217c08-06eb-4a57-b977-7c6d72299301"},
		FIELD_DELIMITER_CHAR, ENTRY_DELIMITER_CHAR);
	...
	Utility::appendBy(expectedChars,
					  {"8811e6bedb87e90cef39de1179f3bd2e", "4", "5000000006000", "M7", "P4/M7.cpp", "23", "1",
	...
	Utility::appendBy(
		expectedChars,
		{"8811e6bedb87e90cef39de1179f3bd2e", "5", "5000000009000", "M10", "P5/M10.cpp", "61", "1", "2a84cf5a-9554-4800-bb87-6dda6715fa12"},
		FIELD_DELIMITER_CHAR, ENTRY_DELIMITER_CHAR);
	expectedChars.pop_back();
...
TEST(DatabaseIntegrationTest, CheckRequestComplete)
{
	...
	expectedChars = {};
	Utility::appendBy(expectedChars,
					  {"137fed017b6159acc0af30d2c6b403a5", "3", "5000000002000", "M3", "P3/M3.cpp", "1", "1",
...
TEST(DatabaseIntegrationTest, GetAuthorIdRequestMultipleAuthor)
{
	...
	// Test:
	std::string output = handler.handleRequest("auid", request, nullptr);
...
TEST(DatabaseIntegrationTest, GetAuthorIdRequestSingleUnknownAuthor)
{
	...
	std::vector<char> requestChars = {};
	Utility::appendBy(requestChars, {"Author1", "author1@mail.com"}, FIELD_DELIMITER_CHAR, ENTRY_DELIMITER_CHAR);
	Utility::appendBy(requestChars, {"UnknownAuthor", "unknownauthor2@mail.com"}, FIELD_DELIMITER_CHAR,
					  ENTRY_DELIMITER_CHAR);
	std::string request(requestChars.begin(), requestChars.end());
...
TEST(DatabaseIntegrationTest, ExtractProjectsRequestDifferentProjects)
{
	...
	std::vector<char> expectedChars = {};
	Utility::appendBy(
		expectedChars, {"2", "5000000001000", "L2", "P2", "www.github.com/p2", "68bd2db6-fe91-47d2-a134-cf82b104f547"},
		FIELD_DELIMITER_CHAR, ENTRY_DELIMITER_CHAR);
	expectedChars.pop_back();
